...
export const UPDATE_HISTORY: UpdateNoteVersion[] = [
  ...
  },
  {
    ...
    required: false,
    newFeatures: [
      { title: 'Mercado de transferências, Simulação de partidas, Mecânicas d…', description: 'src/game/negotiation.ts: Mercado de transferências. src/game/sim.ts: Simulação de partidas. src/game/sondagem.ts: mecânica. src/lib/db.ts: Saves e migração. src/lib/types.ts: Dados e estrutura do…' },
    ],
    improvements: [
    ],
    bugFixes: [
  ...
  {
    version: '1.8.12',
    title: 'Mensagens e notificações, Mercado de transferências, Mecânica…',
    date: '17/08/2026',
    required: false,
    newFeatures: [
      { title: 'Mensagens e notificações, Mercado de transferências, Mecânica…', description: 'src/game/messages.ts: Mensagens e notificações. src/game/negotiation.ts: Mercado de transferências. src/game/sondagem.ts: mecânica. src/game/worldgen.ts: Geração do mundo e elencos. src/lib/db.ts:…' },
    ],
    improvements: [
    ],
    bugFixes: [
